...
COPY 001_init.sh /docker-entrypoint-initdb.d/001_init.sh
COPY 002_main.sql /docker-entrypoint-initdb.d/002_main.sql

# Grant appropriate permissions and set executable flag for the script.
RUN chmod +x /docker-entrypoint-initdb.d/001_init.sh
